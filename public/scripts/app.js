...
var Person = function () {
  ...
  function Person() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "react js course";
  ...
  _createClass(Traveller, [{
    ...
    value: function getGreeting() {
      if (!!this.homeLocation) {
        return _get(Traveller.prototype.__proto__ || Object.getPrototypeOf(Traveller.prototype), "getGreeting", this).call(this) + " visiting from " + this.homeLocation;
      }
...
var traveller1 = new Traveller("first", 33, "hyderabad");
console.log(traveller1.getGreeting());
var traveller2 = new Traveller("second", 30);
